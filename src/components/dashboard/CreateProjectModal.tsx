              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Content Generation API"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="What are the prompts in this project for?"
                    className="w-full bg-[#050505] border border-slate-700 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all resize-none h-24"
                  />
                </div>
